...
work_dir = './work_dirs/student/fold1/segformer_288x288_b0'
#CUDA_VISIBLE_DEVICES=1 PYTHONPATH=$(pwd):$PYTHONPATH python tools/train.py configs/Student/384x288_p/segformer_custom_288x288_fold1.py