...
data_root = '/home/yeonwoo3/DATA/camvid/384x288_fold_p/fold1/'    #UniScale:  /home/yeonwoo3/DATA/camvid/384x288_fold_p/fold1/
...
data = dict(
    ...
    train=dict(
        ...
        test_pipeline=None,
        student_resolution=crop_size,  # 384x384 → 288x288 (비율 유지)
