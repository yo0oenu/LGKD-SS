...
data_root = '/home/yeonwoo3/DATA/camvid/384x512_fold_p/fold2/'  #384 * 512 (H * W)
#data_root = '//home/yeonwoo3/DATA/camvid/384x512_fold2/'
# 데이터 전처리 파이프라인
img_norm_cfg = dict(
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Normalize', **img_norm_cfg),
            dict(type='Pad', size = (384, 512), pad_val=0, seg_pad_val=255),
