...
# 작업 디렉토리
work_dir = './work_dirs/kd/pr_0.01_Multi_LabelTeacher_pre_student/fold1'

# GPU 설정 추가
gpu_ids = range(0, 1)
#PYTHONPATH=$(pwd):$PYTHONPATH python tools/train.py configs/KD/camvid_DIFF2Seg_512t384s_pr_fold1.py